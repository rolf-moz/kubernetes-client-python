...
class V1beta2FlowSchema(BaseModel):
    """
    ...
    spec: Optional[V1beta2FlowSchemaSpec] = None
    status: Optional[V1beta2FlowSchemaStatus] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "spec": V1beta2FlowSchemaSpec.from_dict(obj.get("spec")) if obj.get("spec") is not None else None,
            "status": V1beta2FlowSchemaStatus.from_dict(obj.get("status")) if obj.get("status") is not None else None
        })
        return _obj
