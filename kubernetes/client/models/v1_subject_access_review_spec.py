...
class V1SubjectAccessReviewSpec(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "nonResourceAttributes": V1NonResourceAttributes.from_dict(obj.get("nonResourceAttributes")) if obj.get("nonResourceAttributes") is not None else None,
            "resourceAttributes": V1ResourceAttributes.from_dict(obj.get("resourceAttributes")) if obj.get("resourceAttributes") is not None else None,
            "uid": obj.get("uid"),
            "user": obj.get("user")
        })
        return _obj
