...
class V1beta3PriorityLevelConfiguration(BaseModel):
    ...
    spec: Optional[V1beta3PriorityLevelConfigurationSpec] = None
    status: Optional[V1beta3PriorityLevelConfigurationStatus] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "spec": V1beta3PriorityLevelConfigurationSpec.from_dict(obj.get("spec")) if obj.get("spec") is not None else None,
            "status": V1beta3PriorityLevelConfigurationStatus.from_dict(obj.get("status")) if obj.get("status") is not None else None
        })
        return _obj
