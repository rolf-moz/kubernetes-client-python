...
class V1beta1ValidatingAdmissionPolicyBindingSpec(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "matchResources": V1beta1MatchResources.from_dict(obj.get("matchResources")) if obj.get("matchResources") is not None else None,
            "paramRef": V1beta1ParamRef.from_dict(obj.get("paramRef")) if obj.get("paramRef") is not None else None,
