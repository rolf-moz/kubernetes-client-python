...
class V1beta2PriorityLevelConfigurationList(BaseModel):
    """
    ...
    items: List[V1beta2PriorityLevelConfiguration] = Field(description="`items` is a list of request-priorities.")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "items": [V1beta2PriorityLevelConfiguration.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
            "kind": obj.get("kind"),
