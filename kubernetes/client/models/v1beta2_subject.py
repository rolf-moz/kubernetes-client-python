...
class V1beta2Subject(BaseModel):
    """
    Subject matches the originator of a request, as identified by the request authentication system. There are three ways of matching an originator; by user, group, or service account.
    """ # noqa: E501
    group: Optional[V1beta2GroupSubject] = None
    kind: StrictStr = Field(description="`kind` indicates which one of the other fields is non-empty. Required")
    service_account: Optional[V1beta2ServiceAccountSubject] = Field(default=None, alias="serviceAccount")
    user: Optional[V1beta2UserSubject] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "group": V1beta2GroupSubject.from_dict(obj.get("group")) if obj.get("group") is not None else None,
            "kind": obj.get("kind"),
            "serviceAccount": V1beta2ServiceAccountSubject.from_dict(obj.get("serviceAccount")) if obj.get("serviceAccount") is not None else None,
            "user": V1beta2UserSubject.from_dict(obj.get("user")) if obj.get("user") is not None else None
        })
        return _obj
