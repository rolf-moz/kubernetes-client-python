...
class V1beta3PriorityLevelConfigurationSpec(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "exempt": V1beta3ExemptPriorityLevelConfiguration.from_dict(obj.get("exempt")) if obj.get("exempt") is not None else None,
            "limited": V1beta3LimitedPriorityLevelConfiguration.from_dict(obj.get("limited")) if obj.get("limited") is not None else None,
            "type": obj.get("type")
        })
        return _obj
