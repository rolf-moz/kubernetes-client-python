...
class V1EnvVarSource(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "configMapKeyRef": V1ConfigMapKeySelector.from_dict(obj.get("configMapKeyRef")) if obj.get("configMapKeyRef") is not None else None,
            "fieldRef": V1ObjectFieldSelector.from_dict(obj.get("fieldRef")) if obj.get("fieldRef") is not None else None,
            "resourceFieldRef": V1ResourceFieldSelector.from_dict(obj.get("resourceFieldRef")) if obj.get("resourceFieldRef") is not None else None,
            "secretKeyRef": V1SecretKeySelector.from_dict(obj.get("secretKeyRef")) if obj.get("secretKeyRef") is not None else None
        })
        return _obj
