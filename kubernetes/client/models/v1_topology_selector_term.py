...
class V1TopologySelectorTerm(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "matchLabelExpressions": [V1TopologySelectorLabelRequirement.from_dict(_item) for _item in obj.get("matchLabelExpressions")] if obj.get("matchLabelExpressions") is not None else None
        })
        return _obj
