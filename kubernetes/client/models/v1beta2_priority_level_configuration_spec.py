...
class V1beta2PriorityLevelConfigurationSpec(BaseModel):
    """
    PriorityLevelConfigurationSpec specifies the configuration of a priority level.
    """ # noqa: E501
    exempt: Optional[V1beta2ExemptPriorityLevelConfiguration] = None
    limited: Optional[V1beta2LimitedPriorityLevelConfiguration] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "exempt": V1beta2ExemptPriorityLevelConfiguration.from_dict(obj.get("exempt")) if obj.get("exempt") is not None else None,
            "limited": V1beta2LimitedPriorityLevelConfiguration.from_dict(obj.get("limited")) if obj.get("limited") is not None else None,
            "type": obj.get("type")
        })
        return _obj
