...
class V1beta2LimitResponse(BaseModel):
    """
    LimitResponse defines how to handle requests that can not be executed right now.
    """ # noqa: E501
    queuing: Optional[V1beta2QueuingConfiguration] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "queuing": V1beta2QueuingConfiguration.from_dict(obj.get("queuing")) if obj.get("queuing") is not None else None,
            "type": obj.get("type")
        })
        return _obj
