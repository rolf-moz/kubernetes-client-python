...
```python
from client.models.v1beta3_resource_policy_rule import V1beta3ResourcePolicyRule
...
v1beta3_resource_policy_rule_form_dict = v1beta3_resource_policy_rule.from_dict(v1beta3_resource_policy_rule_dict)
```
