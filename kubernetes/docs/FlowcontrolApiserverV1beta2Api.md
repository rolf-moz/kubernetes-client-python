# client.FlowcontrolApiserverV1beta2Api
...
with client.ApiClient(configuration) as api_client:
    ...
    api_instance = client.FlowcontrolApiserverV1beta2Api(api_client)
    body = client.V1beta2FlowSchema() # V1beta2FlowSchema | 
    ...
    try:
        ...
        print("The response of FlowcontrolApiserverV1beta2Api->create_flow_schema:\n")
        pprint(api_response)
...
with client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = client.FlowcontrolApiserverV1beta2Api(api_client)
    body = client.V1beta2PriorityLevelConfiguration() # V1beta2PriorityLevelConfiguration | 
    pretty = 'pretty_example' # str | If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget). (optional)
    dry_run = 'dry_run_example' # str | When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed (optional)
    field_manager = 'field_manager_example' # str | fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint. (optional)
    field_validation = 'field_validation_example' # str | fieldValidation instructs the server on how to handle objects in the request (POST/PUT/PATCH) containing unknown or duplicate fields. Valid values are: - Ignore: This will ignore any unknown fields that are silently dropped from the object, and will ignore all but the last duplicate field that the decoder encounters. This is the default behavior prior to v1.23. - Warn: This will send a warning via the standard warning response header for each unknown field that is dropped from the object, and for each duplicate field that is encountered. The request will still succeed if there are no other errors, and will only persist the last of any duplicate fields. This is the default in v1.23+ - Strict: This will fail the request with a BadRequest error if any unknown fields would be dropped from the object, or if any duplicate fields are present. The error returned from the server will contain all unknown and duplicate fields encountered. (optional)
    ...
    try:
        ...
        print("The response of FlowcontrolApiserverV1beta2Api->create_priority_level_configuration:\n")
        pprint(api_response)
    except Exception as e:
...
with client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of FlowcontrolApiserverV1beta2Api->delete_collection_flow_schema:\n")
        pprint(api_response)
    except Exception as e:
...
with client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of FlowcontrolApiserverV1beta2Api->delete_collection_priority_level_configuration:\n")
        pprint(api_response)
    except Exception as e:
...
with client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of FlowcontrolApiserverV1beta2Api->delete_flow_schema:\n")
        pprint(api_response)
    except Exception as e:
...
with client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of FlowcontrolApiserverV1beta2Api->delete_priority_level_configuration:\n")
        pprint(api_response)
    except Exception as e:
...
with client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of FlowcontrolApiserverV1beta2Api->get_api_resources:\n")
        pprint(api_response)
    except Exception as e:
...
with client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of FlowcontrolApiserverV1beta2Api->list_flow_schema:\n")
        pprint(api_response)
    except Exception as e:
...
> V1beta2PriorityLevelConfigurationList list_priority_level_configuration(pretty=pretty, allow_watch_bookmarks=allow_watch_bookmarks, var_continue=var_continue, field_selector=field_selector, label_selector=label_selector, limit=limit, resource_version=resource_version, resource_version_match=resource_version_match, send_initial_events=send_initial_events, timeout_seconds=timeout_seconds, watch=watch)
...
with client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of FlowcontrolApiserverV1beta2Api->list_priority_level_configuration:\n")
        pprint(api_response)
    except Exception as e:
...
with client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of FlowcontrolApiserverV1beta2Api->patch_flow_schema:\n")
        pprint(api_response)
    except Exception as e:
...
with client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of FlowcontrolApiserverV1beta2Api->patch_flow_schema_status:\n")
        pprint(api_response)
    except Exception as e:
...
with client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of FlowcontrolApiserverV1beta2Api->patch_priority_level_configuration:\n")
        pprint(api_response)
    except Exception as e:
...
with client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of FlowcontrolApiserverV1beta2Api->patch_priority_level_configuration_status:\n")
        pprint(api_response)
    except Exception as e:
...
with client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of FlowcontrolApiserverV1beta2Api->read_flow_schema:\n")
        pprint(api_response)
    except Exception as e:
...
with client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of FlowcontrolApiserverV1beta2Api->read_flow_schema_status:\n")
        pprint(api_response)
    except Exception as e:
...
with client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of FlowcontrolApiserverV1beta2Api->read_priority_level_configuration:\n")
        pprint(api_response)
    except Exception as e:
...
with client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of FlowcontrolApiserverV1beta2Api->read_priority_level_configuration_status:\n")
        pprint(api_response)
    except Exception as e:
...
with client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of FlowcontrolApiserverV1beta2Api->replace_flow_schema:\n")
        pprint(api_response)
    except Exception as e:
...
with client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of FlowcontrolApiserverV1beta2Api->replace_flow_schema_status:\n")
        pprint(api_response)
    except Exception as e:
...
with client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of FlowcontrolApiserverV1beta2Api->replace_priority_level_configuration:\n")
        pprint(api_response)
    except Exception as e:
...
with client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of FlowcontrolApiserverV1beta2Api->replace_priority_level_configuration_status:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling FlowcontrolApiserverV1beta2Api->replace_priority_level_configuration_status: %s\n" % e)
```
