...
> V1beta1SelfSubjectReview create_self_subject_review(body, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation, pretty=pretty)
...
with client.ApiClient(configuration) as api_client:
    ...
    body = client.V1beta1SelfSubjectReview() # V1beta1SelfSubjectReview | 
...
------------- | ------------- | ------------- | -------------
 **body** | [**V1beta1SelfSubjectReview**](V1beta1SelfSubjectReview.md)|  | 
