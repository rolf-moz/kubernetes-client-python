...
```python
from client.models.v1alpha1_match_resources import V1alpha1MatchResources
...
v1alpha1_match_resources_form_dict = v1alpha1_match_resources.from_dict(v1alpha1_match_resources_dict)
```
