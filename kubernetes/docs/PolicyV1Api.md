...
with client.ApiClient(configuration) as api_client:
    ...
    api_instance = client.PolicyV1Api(api_client)
    namespace = 'namespace_example' # str | object name and auth scope, such as for teams and projects
    body = client.V1PodDisruptionBudget() # V1PodDisruptionBudget | 
...
> V1Status delete_namespaced_pod_disruption_budget(name, namespace, pretty=pretty, dry_run=dry_run, grace_period_seconds=grace_period_seconds, orphan_dependents=orphan_dependents, propagation_policy=propagation_policy, body=body)
...
with client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.delete_namespaced_pod_disruption_budget(name, namespace, pretty=pretty, dry_run=dry_run, grace_period_seconds=grace_period_seconds, orphan_dependents=orphan_dependents, propagation_policy=propagation_policy, body=body)
