...
```python
from client.models.v1beta1_match_condition import V1beta1MatchCondition
...
v1beta1_match_condition_form_dict = v1beta1_match_condition.from_dict(v1beta1_match_condition_dict)
```
