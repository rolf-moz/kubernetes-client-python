...
with client.ApiClient(configuration) as api_client:
    ...
    api_instance = client.SchedulingV1Api(api_client)
    body = client.V1PriorityClass() # V1PriorityClass | 
...
> V1Status delete_priority_class(name, pretty=pretty, dry_run=dry_run, grace_period_seconds=grace_period_seconds, orphan_dependents=orphan_dependents, propagation_policy=propagation_policy, body=body)
...
with client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.delete_priority_class(name, pretty=pretty, dry_run=dry_run, grace_period_seconds=grace_period_seconds, orphan_dependents=orphan_dependents, propagation_policy=propagation_policy, body=body)
