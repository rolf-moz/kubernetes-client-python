...
with client.ApiClient(configuration) as api_client:
    ...
    api_instance = client.StorageV1alpha1Api(api_client)
    body = client.V1alpha1VolumeAttributesClass() # V1alpha1VolumeAttributesClass | 
...
> V1alpha1VolumeAttributesClass delete_volume_attributes_class(name, pretty=pretty, dry_run=dry_run, grace_period_seconds=grace_period_seconds, orphan_dependents=orphan_dependents, propagation_policy=propagation_policy, body=body)
...
with client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.delete_volume_attributes_class(name, pretty=pretty, dry_run=dry_run, grace_period_seconds=grace_period_seconds, orphan_dependents=orphan_dependents, propagation_policy=propagation_policy, body=body)
