# client.AuthenticationV1alpha1Api
...
> V1alpha1SelfSubjectReview create_self_subject_review(body, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation, pretty=pretty)
...
with client.ApiClient(configuration) as api_client:
    ...
    api_instance = client.AuthenticationV1alpha1Api(api_client)
    body = client.V1alpha1SelfSubjectReview() # V1alpha1SelfSubjectReview | 
