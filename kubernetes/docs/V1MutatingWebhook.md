...
**client_config** | [**AdmissionregistrationV1WebhookClientConfig**](AdmissionregistrationV1WebhookClientConfig.md) |  | 
...
v1_mutating_webhook_form_dict = v1_mutating_webhook.from_dict(v1_mutating_webhook_dict)
```
