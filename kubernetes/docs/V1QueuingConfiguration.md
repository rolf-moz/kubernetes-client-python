...
```python
from client.models.v1_queuing_configuration import V1QueuingConfiguration
...
v1_queuing_configuration_form_dict = v1_queuing_configuration.from_dict(v1_queuing_configuration_dict)
```
