...
import os
import client
from client.models.v1_certificate_signing_request import V1CertificateSigningRequest
...
with client.ApiClient(configuration) as api_client:
    ...
    api_instance = client.CertificatesV1Api(api_client)
    body = client.V1CertificateSigningRequest() # V1CertificateSigningRequest | 
