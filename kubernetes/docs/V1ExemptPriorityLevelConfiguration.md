...
```python
from client.models.v1_exempt_priority_level_configuration import V1ExemptPriorityLevelConfiguration
...
v1_exempt_priority_level_configuration_form_dict = v1_exempt_priority_level_configuration.from_dict(v1_exempt_priority_level_configuration_dict)
```
