...
import os
import client
from client.models.v1alpha1_cluster_trust_bundle import V1alpha1ClusterTrustBundle
...
with client.ApiClient(configuration) as api_client:
    ...
    api_instance = client.CertificatesV1alpha1Api(api_client)
    body = client.V1alpha1ClusterTrustBundle() # V1alpha1ClusterTrustBundle | 
...
> V1Status delete_cluster_trust_bundle(name, pretty=pretty, dry_run=dry_run, grace_period_seconds=grace_period_seconds, orphan_dependents=orphan_dependents, propagation_policy=propagation_policy, body=body)
...
with client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.delete_cluster_trust_bundle(name, pretty=pretty, dry_run=dry_run, grace_period_seconds=grace_period_seconds, orphan_dependents=orphan_dependents, propagation_policy=propagation_policy, body=body)
