...
with client.ApiClient(configuration) as api_client:
    ...
    api_instance = client.CoordinationV1Api(api_client)
    namespace = 'namespace_example' # str | object name and auth scope, such as for teams and projects
    body = client.V1Lease() # V1Lease | 
...
> V1Status delete_namespaced_lease(name, namespace, pretty=pretty, dry_run=dry_run, grace_period_seconds=grace_period_seconds, orphan_dependents=orphan_dependents, propagation_policy=propagation_policy, body=body)
